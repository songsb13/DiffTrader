...
class MessageControlMixin(object):
    ...
    def publish_redis_to_api_process(
        self,
        fn_name,
        publish_key,
        logging=None,
        ...
        args=None,
        kwargs=None,
        api_priority=APIPriority.SEARCH,
    ):
        if args is None:
            args = []
...
def subscribe_redis(key, logging=None):
    ...
    if logging:
        CMsg.entrance_with_parameter(subscribe_redis, (key,))
...
def get_redis(key, use_decimal=False, logging=None):
    ...
    """
    if logging:
        logging.debug(CMsg.entrance_with_parameter(set_redis, (key, use_decimal)))
...
def set_redis(key, value, use_decimal=False, logging=None):
    ...
    if logging:
        logging.debug(
            CMsg.entrance_with_parameter(set_redis, (key, value, use_decimal))
        )
...
if __name__ == "__main__":
    dd = [
        {
            "balance": {
                "BTC": Decimal("0.00965321"),
                "ETH": Decimal("0.79017703"),
                "USDT": Decimal("0.23487871"),
                "KNC": Decimal("0.07830000"),
                "ARK": Decimal("0.00715000"),
                "XRP": Decimal("1.20388500"),
                "ADA": Decimal("0.27135491"),
                "BUSD": Decimal("0.01712369"),
            },
            "deposit": {
                "BTC": "18tqAJGjchLNCGpm4L3WqdWatB51oTjhPP",
                "ETH": "0x817f37daf92fcb3f019bae400fccf3c5b49ed67f",
            },
            "transaction_fee": {
                "AGLD": Decimal("25"),
                "STPT": Decimal("298"),
                ...
                "EUR": Decimal("0"),
                "AMP": Decimal("959"),
                "BOT": Decimal("0.000099"),
                "NULS": Decimal("0.51"),
                "AUTO": Decimal("0.00047"),
                "NGN": Decimal("0"),
                "ANC": Decimal("0.2"),
                "BDOT": Decimal("0"),
                "EGLD": Decimal("0.0013"),
            ...
            "trading_fee": {"BTC": Decimal("0.0010000000")},
            "fee_count": 1,
        }
    ]
